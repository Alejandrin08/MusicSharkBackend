...
module.exports = {
    async up(queryInterface, Sequelize) {
        await queryInterface.bulkInsert('musicgenresong', [
            ...
            { musicgenreid: 7, songid: 11, createdAt: new Date(), updatedAt: new Date() },
            { musicgenreid: 2, songid: 12, createdAt: new Date(), updatedAt: new Date() },
            { musicgenreid: 2, songid: 13, createdAt: new Date(), updatedAt: new Date() },
            { musicgenreid: 2, songid: 14, createdAt: new Date(), updatedAt: new Date() },
            { musicgenreid: 2, songid: 15, createdAt: new Date(), updatedAt: new Date() },
            ...
            { musicgenreid: 3, songid: 11, createdAt: new Date(), updatedAt: new Date() },
